...
type GpuServiceClient interface {
	...
	DeleteGpu(ctx context.Context, in *DeleteGpuRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *gpuServiceClient) DeleteGpu(ctx context.Context, in *DeleteGpuRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type GpuServiceServer interface {
	...
	// DeleteGpu deletes a single GPU resource.
	DeleteGpu(context.Context, *DeleteGpuRequest) (*empty.Empty, error)
...
func (UnimplementedGpuServiceServer) DeleteGpu(context.Context, *DeleteGpuRequest) (*empty.Empty, error) {
